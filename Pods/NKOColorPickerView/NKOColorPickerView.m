...
CGFloat const NKOPickerViewGradientViewHeight           = 20.f;
...
CGFloat const NKOPickerViewBrightnessIndicatorHeight    = 28.f;
CGFloat const NKOPickerViewCrossHairshWidthAndHeight    = 28.f;
