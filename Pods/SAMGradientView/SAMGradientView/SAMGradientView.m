...
- (UIColor *)colorForPercent:(CGFloat)percent
{
    ...
    CGContextRef context = CGBitmapContextCreate(NULL, 100, 1, 8, 0, colorSpace,     kCGImageAlphaPremultipliedLast);
    
    // draw the gradient into it
    CGContextAddRect(context, CGRectMake(0, 0, 100, 1));
